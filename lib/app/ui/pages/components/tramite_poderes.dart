...
Widget poderes(BuildContext context, SeguimientoTramiteController controller) {
  final tramite = controller.tramitePoderes.value;
  if (tramite == null) {
    ...
    child: ListView(
      ...
      children: [
        ...
        _buildSection(
          ...
          icon: Icons.person,
          children: [
            _buildInfoRow('Nombre', objeto.nombreCompleto),
          ],
        ),
        ...
        _buildSection(
          ...
          children: [
            _buildInfoRow('Código', objeto.codTramite),
            _buildInfoRow('Oficina Consular', objeto.oficinaConsular),
            _buildInfoRow('Tipo de Trámite', objeto.descripcionArancel),
            _buildInfoRow('Fecha de Solicitud', _formatDate(objeto.fecha)),
          ],
        ),
        const SizedBox(height: 5),
