...
import '../../../models/consulado/model_tramite_vivencias.dart';

Widget vivencias(
    BuildContext context, SeguimientoTramiteController controller) {
  final tramite = controller.tramiteVivencias.value;
  if (tramite == null) {
    ...
    child: ListView(
      ...
      children: [
        ...
        _buildSection(
          ...
          icon: Icons.person,
          children: [
            _buildInfoRow('Nombre Completo', objeto.nombreCompleto),
            _buildInfoRow('Contacto', objeto.contacto),
            _buildInfoRow('Entidad', objeto.entidad),
          ],
        ),
        ...
        _buildSection(
          ...
          children: [
            _buildInfoRow('ID', objeto.id.toString()),
            _buildInfoRow('Gestión', objeto.gestionVivencia.toString()),
            _buildInfoRow('Periodo', objeto.periodo),
            _buildInfoRow('Fecha Local', _formatDate(objeto.fechaLocal)),
            _buildInfoRow('Fecha Registro', _formatDate(objeto.fechaRegistro)),
          ],
        ),
        const SizedBox(height: 5),
        ...
        _buildSection(
          ...
          icon: Icons.timeline,
          children: [
            if (objeto.listaSeguimiento.isEmpty)
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
...
Widget _buildTimelineItem({
  required Seguimiento seguimiento,
