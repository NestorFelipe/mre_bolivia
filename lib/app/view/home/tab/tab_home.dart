                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Icon(Icons.error_outline,
                                              ...
                                              size: 48.w),
                                          getVerSpace(8),
                                          getCustomFont("Error inesperado", 16,
                                              Colors.red, 2,
                                              fontWeight: FontWeight.w600,
                                              textAlign: TextAlign.center),
                                        ],
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          getAssetImage(
                                              "${region.nombre}.png", 44, 44),
                                          getVerSpace(10),
                                          getCustomFont(region.nombre, 14,
                                              Colors.black, 1,
                                              fontWeight: FontWeight.w400),
                                        ],
                                      ),
                          ...
                          child: Obx(() {
                            try {
                              ...
                              return ListView.builder(
                                ...
                                scrollDirection: Axis.horizontal,
                                itemCount:
                                    servicios.length > 3 ? 3 : servicios.length,
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    onTap: () =>
                                        controller.goToServicio(service),
                                    child: Container(
                                      width: 177.w,
                                      decoration: BoxDecoration(
                                          color: Colors.white,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            width: 153.w,
                                            height: 28.h,
                                            child: getCustomFont(service.titulo,
                                                11, Colors.grey[600]!, 2,
                                                textAlign: TextAlign.center,
                                                fontWeight: FontWeight.w800),
                                          ),
                                        ],
