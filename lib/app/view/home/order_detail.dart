          ...
          body: SafeArea(
            child: Column(
              children: [
                ...
                getPaddingWidget(EdgeInsets.symmetric(horizontal: horspace),
                    processTracker()),
                getVerSpace(FetchPixels.getPixelHeight(30)),
                Expanded(
                  flex: 1,
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      getCustomFont(modelCart.productName ?? "",
                                          14, textColor, 1,
                                          fontWeight: FontWeight.w400),
                                      getVerSpace(
                                          FetchPixels.getPixelHeight(9)),
                                      getCustomFont("\$${modelCart.price}", 16,
                                          blueColor, 1,
                                          fontWeight: FontWeight.w800)
                                    ],
                                  )
        ...
        children: [
          Row(
            children: [
              ...
              getHorSpace(FetchPixels.getPixelWidth(12)),
              getCustomFont("$date $month, $year, $time", 16, Colors.black, 1,
                  fontWeight: FontWeight.w400)
            ],
          ),
