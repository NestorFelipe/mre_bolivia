...
class _CartScreenState extends State<CartScreen> {
  Map<String, ModelCart> cartLists = DataFile.cartList;
  List<ModelCart> list = [];
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      getPaddingWidget(
                        ...
                        getCustomFont(
                            "Frequently added together", 20, Colors.black, 1,
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  getCustomFont(modelOther.name ?? "", 16,
                                      Colors.black, 1,
                                      fontWeight: FontWeight.w800),
                                  getVerSpace(FetchPixels.getPixelHeight(6)),
                                  getCustomFont(
                                      "\$${modelOther.price}", 14, blueColor, 1,
                                      fontWeight: FontWeight.w800),
                                  getVerSpace(FetchPixels.getPixelHeight(10)),
                                  getButton(context, Colors.white, "Add",
                                      blueColor, () {}, 14,
                                      ...
                                      borderWidth:
                                          FetchPixels.getPixelHeight(1.5),
                      ...
                      getPaddingWidget(
                        ...
                        Row(
                          ...
                          children: [
                            getCustomFont(
                                "Service Charge Total", 16, Colors.black, 1,
                        ...
                        Row(
                          ...
                          children: [
                            getCustomFont("Total", 24, Colors.black, 1,
                                fontWeight: FontWeight.w800),
                            getCustomFont(
                                "\$${total - discount}", 24, Colors.black, 1,
                                fontWeight: FontWeight.w800)
                          ],
                        ),
                      ),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            getCustomFont(
                                modelCart.name ?? '', 16, Colors.black, 1,
                                fontWeight: FontWeight.w800),
                      ...
                      children: [
                        GestureDetector(
                          ...
                          onTap: () {
                            ...
                            setState(() {
                              cartLists.removeWhere((key, value) => value.name == list[index].name);
                            });
                          },
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            getCustomFont(modelCart.quantity.toString(), 14,
                                Colors.black, 1,
                                fontWeight: FontWeight.w400),
                            getHorSpace(FetchPixels.getPixelWidth(10)),
                            GestureDetector(
